...
class TestDAF(unittest.TestCase):
    ...
    def test_GIVEN_cli_argument_WHEN_passing_experiment_option_THEN_check_parsed_args(self):
    ...
    def test_GIVEN_cli_argument_WHEN_passing_umatrix_option_THEN_check_parsed_args(self):
