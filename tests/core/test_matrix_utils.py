...
class TestMatrixUtils(unittest.TestCase):
    ...
    def test_pseudo_angle_structure(self):
        ...
        mu, eta, chi, phi, nu, del_ = 10.73240, 5.36620, 35.26439, 45.00000, 0.00000, 0.00000
        ...
        expected_keys = {'alpha', 'qaz', 'naz', 'tau', 'psi', 'beta', 'omega',
                        'twotheta', 'theta', 'q_vector', 'q_vector_norm'}
