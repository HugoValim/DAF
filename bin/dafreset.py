...
parser.add_argument('--hard', action='store_true', help='If used resets all setups to default')
parser.add_argument('--realhard', action='store_true', help='If used deletes all setups and then resets to default')
