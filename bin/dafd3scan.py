#!/usr/bin/env python3
"""Perform an relative scan in three of the diffractometer motors"""
...
'prescan': 'ls', 'postscan': 'pwd', 'plot_type': args.show_plot, 'relative': False, 'reset': True, 'step_mode': False, 
