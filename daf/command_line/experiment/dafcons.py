...
parser.add_argument(
    "-m", "--cons_Mu", metavar="ang", type=float, help="Constrain Mu, default: 0"
)
parser.add_argument(
    "-e", "--cons_Eta", metavar="ang", type=float, help="Constrain Eta, default: 0"
)
parser.add_argument(
    "-c", "--cons_Chi", metavar="ang", type=float, help="Constrain Chi, default: 0"
)
parser.add_argument(
    "-p", "--cons_Phi", metavar="ang", type=float, help="Constrain Phi, default: 0"
)
parser.add_argument(
    "-n", "--cons_Nu", metavar="ang", type=float, help="Constrain Nu, default: 0"
)
parser.add_argument(
    "-d", "--cons_Del", metavar="ang", type=float, help="Constrain Del, default: 0"
)
parser.add_argument(
    "-a", "--cons_alpha", metavar="ang", type=float, help="Constrain alpha, default: 0"
)
parser.add_argument(
    "-b", "--cons_beta", metavar="ang", type=float, help="Constrain beta, default: 0"
)
parser.add_argument(
    "-psi", "--cons_psi", metavar="ang", type=float, help="Constrain psi, default: 0"
)
parser.add_argument(
    "-o", "--cons_omega", metavar="ang", type=float, help="Constrain omega, default: 0"
)
parser.add_argument(
    "-q", "--cons_qaz", metavar="ang", type=float, help="Constrain qaz, default: 0"
)
parser.add_argument(
    "-cnaz", "--cons_naz", metavar="ang", type=float, help="Constrain naz, default: 0"
)
parser.add_argument(
    "-r",
    "--Reset",
