...
class HKLScan(ScanBase):
    ...
    def parse_command_line(self):   
        ...
        self.parser.add_argument(
            "hklf", metavar=("Hf, Kf, Lf"), type=float, nargs=3, help="Final HKL for scan"
        )
        self.parser.add_argument(
            "-n",
            "--scan_name",
        ...
        self.parser.add_argument("-s", "--step", metavar="", type=float, help="Step for the scan")
        self.parser.add_argument(
            "-sep",
            "--separator",
            metavar="",
        ...
        self.parser.add_argument("-v", "--verbose", action="store_true", help="Show full output")
        self.parser.add_argument(
            "-c", "--calc", action="store_true", help="Only calc the scan without perform it"
        )
...
# )
# parser.add_argument(
#     "points", metavar="points", type=float, help="Number of points for the scan"
# )
# parser.add_argument(
#     "time",
#     metavar="time",
...
#     Mu=Mu_bound, Eta=Eta_bound, Chi=Chi_bound, Phi=Phi_bound, Nu=Nu_bound, Del=Del_bound
# )
# exp.set_U(U)
# exp.set_constraints(
...
# scan_points = exp.scan(
#     args.hkli,
#     args.hklf,
#     int(args.points),
#     diflimit=dic["max_diff"],
#     name=dic["scan_name"],
#     write=True,
#     sep=dic["separator"],
