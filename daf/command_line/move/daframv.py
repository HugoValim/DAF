...
parser.add_argument(
    "-m", "--mu", metavar="ang", type=float, help="Start and end for Mu"
)
parser.add_argument(
    "-e", "--eta", metavar="ang", type=float, help="Start and end for Eta"
)
parser.add_argument(
    "-c", "--chi", metavar="ang", type=float, help="Start and end for Chi"
)
parser.add_argument(
    "-p", "--phi", metavar="ang", type=float, help="Start and end for Phi"
)
parser.add_argument(
    "-n", "--nu", metavar="ang", type=float, help="Start and end for Nu"
)
parser.add_argument(
    "-d", "--del", metavar="ang", type=float, help="Start and end for Del"
)
