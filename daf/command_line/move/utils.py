...
class MoveBase:
    ...
    def calculate_hkl(self, hkl: list) -> float:
        ...
        startvalue = [self.experiment_file_dict["Mu"], self.experiment_file_dict["Eta"], self.experiment_file_dict["Chi"], self.experiment_file_dict["Phi"], self.experiment_file_dict["Nu"], self.experiment_file_dict["Del"]]
