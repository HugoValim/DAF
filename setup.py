...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "daf.ascan = daf.command_line.scan.a_scans:ascan1_main",
            "daf.a2scan = daf.command_line.scan.a_scans:a2scan_main",
            "daf.a3scan = daf.command_line.scan.a_scans:a3scan_main",
            "daf.a4scan = daf.command_line.scan.a_scans:a4scan_main",
            "daf.a5scan = daf.command_line.scan.a_scans:a5scan_main",
            "daf.a6scan = daf.command_line.scan.a_scans:a6scan_main",
            "daf.lup = daf.command_line.scan.a_scans:dscan1_main",
            "daf.dscan = daf.command_line.scan.a_scans:dscan1_main",
            "daf.d2scan = daf.command_line.scan.a_scans:d2scan_main",
            "daf.d3scan = daf.command_line.scan.a_scans:d3scan_main",
            "daf.d4scan = daf.command_line.scan.a_scans:d4scan_main",
            "daf.d5scan = daf.command_line.scan.a_scans:d5scan_main",
            "daf.d6scan = daf.command_line.scan.a_scans:d6scan_main",
