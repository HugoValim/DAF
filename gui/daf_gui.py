...
class MyDisplay(Display):
    ...
    def update(self):
        ...
        mode_text = (
            "MODE: "
            + str(data_to_update["mode_num"][0])
            + str(data_to_update["mode_num"][1])
            + str(data_to_update["mode_num"][2])
            + str(data_to_update["mode_num"][3])
            + str(data_to_update["mode_num"][4])
        )
